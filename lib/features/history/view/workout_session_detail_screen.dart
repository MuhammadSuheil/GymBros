        ...
        children: [
          ...
          ListView.separated(
            ...
            separatorBuilder: (context, index) =>
                const Divider(height: 1, thickness: 0.5, color: AppColors.divider), // Gunakan warna divider
          )
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label,
              style: const TextStyle(
                  fontWeight: FontWeight.w600, color: AppColors.onPrimary)),
